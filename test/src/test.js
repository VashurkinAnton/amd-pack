(function (root, factory, getModules) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        root.testModule = factory(require);
  }
	...
	//Module file: /amd-pack/node_modules/jquery/dist/jquery.js
	(function(){
		var module = {};
		Object.defineProperty(module, 'exports', {
			...
			set: _exports.bind(null, '/amd-pack/node_modules/jquery/dist/jquery.js')
		});
		/*!
					...
					if ( support.qsa &&
						...
						// Exclude object elements
							...
							if ( (nid = context.getAttribute( "id" )) ) {
								nid = nid.replace( rescape, "\\@AMD_MODULE@" );
							} else {
		...
		function dataAttr( elem, key, data ) {
			...
			if ( data === undefined && elem.nodeType === 1 ) {
				name = "data-" + key.replace( rmultiDash, "-@AMD_MODULE@" ).toLowerCase();
				...
				return access( this, function( value ) {
					...
					if ( elem && value === undefined ) {
						...
						data = dataUser.get( elem, key ) ||
							...
							dataUser.get( elem, key.replace( rmultiDash, "-@AMD_MODULE@" ).toLowerCase() );
						if ( data !== undefined ) {
							return data;
						}
